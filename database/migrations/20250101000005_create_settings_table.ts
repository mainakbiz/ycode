...
export async function up(knex: Knex): Promise<void> {
  ...
  // Pass raw values — knex serializes them into the jsonb column once. Calling
  // JSON.stringify here would double-encode (e.g. site_name → "\"Ycode Site\"").
  await knex('settings').insert([
    { key: 'site_name', value: 'Ycode Site' },
    { key: 'site_description', value: 'Built with Ycode' },
